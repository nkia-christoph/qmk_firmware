...
/**
  ...
  *                 `--------------------'  `--------------------'
  */
#define _JPNS_L1     KC_B   , KC_U   , KC_X   , DE_SS  , DE_UE
#define _JPNS_L2     KC_H   , KC_I   , KC_E   , KC_A   , KC_O
#define _JPNS_L3     KC_K   , DE_Y   , DE_OE  , DE_AE  , KC_Q
#define _JPNS_L4                       LEFT   , RS_L   , LW_L

#define _JPNS_R1     KC_P   , KC_C   , KC_L   , KC_M   , KC_F
#define _JPNS_R2     KC_D   , KC_T   , KC_R   , KC_N   , KC_S
#define _JPNS_R3     KC_J   , KC_G   , KC_W   , KC_V   , DE_Z
#define _JPNS_R4     RS_R   , LW_R   , RIGHT
...
/**
  ...
  *                 `--------------------'  `--------------------'
  */
#define _STD_L1        KC_Q   , KC_W   , KC_E   , KC_R   , KC_T
#define _STD_L2        KC_A   , KC_S   , KC_D   , KC_F   , KC_G
#define _STD_L3        KC_Z   , KC_X   , KC_C   , KC_V   , KC_B
#define _STD_L4                          KC_SPC , KC_SPC , KC_SPC

#define _STD_R1        KC_Y   , KC_U   , KC_I   , KC_O   , KC_P   ,DE_UE
#define _STD_R2        KC_H   , KC_J   , KC_K   , KC_L   , KC_SCLN,DE_AE
#define _STD_R3        KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH,S(KC_ENT)
#define _STD_R4        KC_ENT , DE_LESS, KC_ALGR
...
#define _LOWER_R1         ALT_MCR, DE_AMPR, DE_MINS, DE_EQL , DE_GRV
